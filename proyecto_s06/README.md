...
Este proyecto englobará todas las habilidades que has adquirido hasta ahora: python, preprocesamiento de datos, analisis exploratorio, analisis estadistico.
